...
;WITH target_tables AS (
    SELECT OBJECT_ID(N'dbo.ASISTENCIATAJAMAR') AS id UNION ALL
...
COMMIT TRANSACTION;
GO
PRINT 'Migration completed: ROLESCHARLASTAJAMAR, CURSOSTAJAMAR, USUARIOSTAJAMAR, CURSOSUSUARIOSTAJAMAR, ASISTENCIATAJAMAR, DISPOSITIVOSTAJAMAR, POSICIONESTAJAMAR, DISPOSITIVOPOSICIONTAJAMAR, POSICIONUSUARIOSTAJAMAR, CHECKINSTAJAMAR.';
...
PRINT 'Added check-in tables: DISPOSITIVOSTAJAMAR, POSICIONESTAJAMAR, DISPOSITIVOPOSICIONTAJAMAR, POSICIONUSUARIOSTAJAMAR, CHECKINSTAJAMAR.';
